              ...
              messages: [
                {
                  ...
                  content: `
                    ...
                    Be strict and detailed like GitHub Copilot.
                    ...
                    - No empty responses
                    If you find no issues, still suggest improvements.
...
${diff.slice(0, 15000)}
      ...
      for (const issue of parsed.issues) {
        try {
          await octokit.pulls.createReviewComment({
            ...
            body: `🚨 **${issue.severity.toUpperCase()} | ${issue.type.toUpperCase()}**
    ...
    await octokit.issues.createComment({
      ...
      ### 🚦 Verdict
      ${parsed?.verdict === "request_changes" ? "❌ Request Changes" : "✅ Approved"}

      ---

      ### 🔍 Issue Breakdown
      ${parsed?.issues?.map(i => `- ${i.title} (${i.severity})`).join("\n")}
